...
export const reportApi = {
    ...
    getDraft: (chartId: number) =>
        http
            .get<ReportDocumentResponse | null>(`/api/reports/charts/${chartId}/draft`)
            .then((r) => r.data),
    ...
    createSnapshot: (chartId: number, body: ReportSnapshotCreateRequest) =>
        http
            .post<ReportDocumentResponse>(`/api/reports/charts/${chartId}/snapshots`, body)
            .then((r) => r.data),
    ...
    createEvent: (chartId: number, body: TrainingEventAppendRequest) =>
        http
            .post<TrainingEventResponse>(`/api/reports/charts/${chartId}/events`, body)
            .then((r) => r.data),
